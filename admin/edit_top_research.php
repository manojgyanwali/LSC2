...
include('../includes/dbcon.php');
    ...
    if(isset($_REQUEST['update_top_research']))
    {
...
//sub image3 upload
    ...
    $qry="update   top_research set image=?,sub_image1=?,sub_image2=?,sub_image3=?,title=?,description=?,date=? where id=?";
            ...
            <div class="container" style="padding-left:140px;">
                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <!-- top research  -->
                            <?php  $qry="select *from top_research where id=?";
                                $result=$conn->prepare($qry);
                                ...
                                <div class="contents" style="padding:20px;">
                                    ...
                                    <form action="" method="POST" enctype="multipart/form-data">
                                                                ...
                                                                <label><b>Upload Research Highlight Image (250*250)</b></label> <br>
                                                                    ...
                                                                    <textarea class="form-control" name="description" id="" cols="20" rows="10" required><?php echo $data['description']; ?></textarea>

                                                            

                                                                <button type="submit" name="update_top_research" class="btn btn-info">Update Top Research</button>
                                    </form>
                                </div>
                            </div>
